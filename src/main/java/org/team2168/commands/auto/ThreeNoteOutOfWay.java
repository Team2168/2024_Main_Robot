...
public class ThreeNoteOutOfWay extends SequentialCommandGroup {
  /** Creates a new ThreeNoteOutOfWay. */
  public ThreeNoteOutOfWay(Drivetrain drivetrain, IntakeRoller intakeRoller, IntakePivot intakePivot, Indexer indexer, Shooter shooter, ShooterPivot shooterPivot, Limelight limelight, LEDs leds) {
